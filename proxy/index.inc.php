...
?>
  <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    <ul id="form">
      <li id="address_bar"><label>Web Address <input id="address_box" type="text" name="<?php echo $GLOBALS['_config']['url_var_name'] ?>" value="http://roomquest.ru/" onfocus="this.select()" /></label> <input id="go" type="submit" value="Go" /></li>
    </ul>
  </form>
